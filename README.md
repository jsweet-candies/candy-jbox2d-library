# JSweet jbox2d-library candy

## Description

This project is a Java bridge to the jbox2d-library library, so that jbox2d-library can be used from Java (thanks to the JSweet transpiler).
